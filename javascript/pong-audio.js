...
export var wallSound = new soundFile("clash_sfx.mp3"); //load sound
...
export var adventureMusic = new soundFile("obi_v_ani.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -6;

export var villageMusic = new soundFile("obi_v_ani.mp3");
soundArray.push(villageMusic);
villageMusic.player.loop = true;
villageMusic.player.volume.value = -6;
